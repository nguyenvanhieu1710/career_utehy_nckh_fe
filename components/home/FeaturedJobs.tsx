...
export default function FeaturedJobs() {
  const [jobs, setJobs] = useState<FeaturedJobItem[]>([]);
      ...
      .catch((e: any) => {
        ...
        setError(
          e?.response?.data?.detail ||
            e?.message ||
            "Không tải được danh sách việc làm nổi bật.",
        );
      })
      .finally(() => {
      ...
      <div className="w-full px-4">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-16 text-gray-500">
            ...
            <p className="text-sm">Đang tải việc làm nổi bật…</p>
          </div>
        ) : error ? (
