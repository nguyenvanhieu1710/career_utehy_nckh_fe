      ...
      .then((res) => {
        ...
        if (resData.status == "success") {
          ...
          if (userData.refresh_token) {
            setRefreshTokenCookie(userData.refresh_token);
          }
          setUserStorage(
            userData.email,
            userData.user_name,
          ...
          {verifyState == "ok" ? (
            <>
              <div className="flex flex-col items-center text-green-800">
                ...
                <div>
                  Chào mừng <strong>{localStorage.getItem("fullname")}</strong>{" "}
                  đã tham gia
                </div>
            ...
            <>
              <div className="flex flex-col items-center text-red-800">
                ...
                <div className="font-bold">Xác thực không thành công !</div>
                <div className="">
                  Thư xác thực đã hết hạn hoặc đã được sử dụng, vui lòng đăng ký
                  lại{" "}
                  <Link
                    href={"/auth/signup"}
